    ...
    if fileName.endswith(".out"):
       with open(path+fileName, "r") as inFile:
           try:
             ...
             if language in params and "nospaces-bptt-rnn" in params:
...
for fileName in os.listdir(path):
   if fileName.startswith(language+"_char-lm") and "bptt-2" in fileName and "rnn" in fileName and not fileName.endswith(".tar"):
    try:
      with open(path+fileName, "r") as inFile:
