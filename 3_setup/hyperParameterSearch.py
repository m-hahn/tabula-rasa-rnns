...
bounds.append(["weight_dropout_hidden", float] + [x/20.0 for x in range(8)])
bounds.append(["char_dropout_prob", float] + [x/40.0 for x in range(15)])
bounds.append(["char_noise_prob",  float] + [0.01, 0.02, 0.05])
bounds.append(["learning_rate", float, 0.05, 0.1, 0.2])
